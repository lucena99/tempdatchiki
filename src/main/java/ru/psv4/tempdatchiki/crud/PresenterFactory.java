...
import ru.psv4.tempdatchiki.ui.views.incidents.IncidentsView;
...
public class PresenterFactory {
	...
	@Bean
	@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
	public EntityPresenter<Incident, IncidentsView> incidentEntityPresenter(IncidentService crudService, CurrentUser currentUser) {
		return new EntityPresenter<>(crudService, currentUser);
	}
}
